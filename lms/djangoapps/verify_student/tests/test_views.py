...
class TestInCourseReverifyView(ModuleStoreTestCase):
    ...
    def test_checkpoint_post(self):
        """
        Test that sending user gets 400 (Bad Request) response on sending
        POST request with invalid checkpoint location.
        """
    ...
    def _create_checkpoint(self):
        """Helper method for creating a reverifcation checkpoint."""
